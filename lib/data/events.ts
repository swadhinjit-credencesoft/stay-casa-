...
export const introContent = {
  ...
  description: 'Located on New Sanganer Road in Sodala, Jaipur, Stay Casa Inn offers a comfortable and convenient venue for intimate events and gatherings. Our team is dedicated to ensuring every event is organized smoothly, allowing you to focus on enjoying the occasion with your guests.',
} as const;
