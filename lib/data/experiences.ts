...
export const expHero = {
  ...
  description:
    "At Stay Casa Inn Jaipur, every guest is welcomed with comfort, cleanliness, and personalized service. Located on New Sanganer Road in Sodala, our hotel is designed to provide a relaxing and hassle-free stay for business travelers, families, couples, and solo explorers.",
} as const;
